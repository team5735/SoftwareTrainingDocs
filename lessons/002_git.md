...
> [!NOTE]
> The commit technically still exists, it's just that nothing else in the repository mentions it, so it's unreachable. These commits will stay in the repository indefinitely untill you run `git gc`.
